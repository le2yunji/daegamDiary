			...
			(glb) => {
                ...
                if (glb.animations && glb.animations.length > 0) {
					...
					glb.animations.forEach((clip) => {
						console.log('애니메이션 클립 이름:', clip.name);
						console.log('수정되는 트랙:', clip.tracks);
					});

                    // this.actions[0].play();
					this.actions[0].setEffectiveTimeScale(0.5);
                    this.actions[0].play()
					console.log('Is animation running:', this.actions[0].isRunning());
